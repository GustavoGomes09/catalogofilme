import { alterarFilme, alterarimagem, buscarPorId,buscarPorNome, deletarFilme, inserirfilme, listarTodosFilmes } from "../repository/filmerepository.js";
...
server.post('/filme', async (req, resp) => {
    try {
        ...
        if(filmeParaInserir.avaliacao == undefined || filmeParaInserir.avaliacao <0)
           throw new Error('Avaliação do filme é obrigatoria');
